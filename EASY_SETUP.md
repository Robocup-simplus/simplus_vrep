...
Afterwards, download simplus_vrep-master file from [Simplus Github](https://github.com/Robocup-simplus/simplus_vrep/archive/master.zip), and extract the downloaded file to the interested directory, and move the simplus_vrep-master/models/SimPlus folder to vrep models directory.
